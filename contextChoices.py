...
vocabulary = {
    1: ["bear", "camel", "cat", "kitten", "cow", "crab", "crocodile", "bird", "deer", "dog", "puppy", 
        "dolphin", "duck", "elephant", "fish", "fox", "giraffe", "goat", "hedgehog", "horse", "jellyfish", 
        "kangaroo", "whale", "lion", "monkey", "octopus", "peacock", "pig", "rabbit", "seahorse", "shark", 
        "sheep", "shrimp", "snake", "starfish", "tiger", "turtle", "whale", "wolf", "zebra"],
